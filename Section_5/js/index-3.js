...
// date string
dt = new Date("September 16, 2016");
//alert(dt);

// date with year, month, hour, minute, second and milliseconds
dt = new Date(2003,5,24,6,40,12,0); // month argument range from 0-11
//alert(dt);
